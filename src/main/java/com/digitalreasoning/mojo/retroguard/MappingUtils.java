...
/**
 * Copied from maven-war-plugin.
 *
 * Utilities used to evaluate expression.
 * <p/>
 * TODO: this comes from the assembly plugin; refactor when it's shared.
 * <p/>
 * The expression might use any field of the {@link org.apache.maven.artifact.Artifact} interface. Some
 * examples might be:
 * <ul>
...
public class MappingUtils
{
    ...
    /**
     * Internal implementation of {@link org.codehaus.plexus.interpolation.ValueSource}
     */
